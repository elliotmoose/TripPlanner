...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionTopPanelBackgroundColor = UIColor(hue: 148/360, saturation: 0.68, brightness: 0.54, alpha: 1)
    ...
    open var optionSelectorPanelBackgroundColor = UIColor(hue: 148/360, saturation: 0.68, brightness: 0.54, alpha: 0.9)
    ...
    ///
    open static func instantiate() -> Trip_Planner.WWCalendarTimeSelector {
...
//        }
        ...
        return UIStoryboard(name: "WWCalendarTimeSelector", bundle: Bundle.main).instantiateInitialViewController() as! Trip_Planner.WWCalendarTimeSelector
    }
